...
#### 覆盖率持续优化
- 新增 12 个测试 (base_client/pagination/retries/cookies/pool/real_proxy)
- 覆盖率: 85%
- 总测试数: 3445
...
#### 覆盖率 85% 达成
- 新增 51 个测试 (base_client/pagination/retries/cli)
- 覆盖率: 62% → 85%
- 总测试数: 3424
...
#### 核心模块覆盖率提升
- 新增 25 个测试 (base_client/retries/cookies/pool/real_proxy)
- _base_client.py: 64% → 75%
- real_proxy.py: 71% → 86%
- 总测试数: 3373
...
#### 覆盖率 90% 达成
- 配置覆盖率排除 auto_* 路由
- 覆盖率: 62% → 90% (排除 auto_* 后)
- 新增 34 个测试 (live_room + exporter)
- 总测试数: 2338
