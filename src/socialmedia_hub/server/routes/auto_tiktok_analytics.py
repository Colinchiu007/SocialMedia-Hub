...
async def fetch_video_metrics(
    ...
    return await proxy_request("tiktok", "/api/v1/tiktok/analytics/fetch_video_metrics", params=params)
...
async def detect_fake_views(
    ...
    return await proxy_request("tiktok", "/api/v1/tiktok/analytics/detect_fake_views", params=params)
...
async def fetch_comment_keywords(
    ...
    if item_id is not None:
        params["item_id"] = item_id
    return await proxy_request("tiktok", "/api/v1/tiktok/analytics/fetch_comment_keywords", params=params)
...
async def fetch_creator_info_and_milestones(
    ...
    return await proxy_request("tiktok", "/api/v1/tiktok/analytics/fetch_creator_info_and_milestones", params=params)
