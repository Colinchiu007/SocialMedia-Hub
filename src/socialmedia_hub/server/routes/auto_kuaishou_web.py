...
async def fetch_one_video(
    ...
    return await proxy_request("kuaishou", "/api/v1/kuaishou/web/fetch_one_video", params=params)
...
async def fetch_one_video_v2(
    ...
    return await proxy_request("kuaishou", "/api/v1/kuaishou/web/fetch_one_video_v2", params=params)
...
async def fetch_one_video_by_url(
    ...
    if url is not None:
        params["url"] = url
    return await proxy_request("kuaishou", "/api/v1/kuaishou/web/fetch_one_video_by_url", params=params)
...
async def fetch_one_video_comment(
    ...
    return await proxy_request("kuaishou", "/api/v1/kuaishou/web/fetch_one_video_comment", params=params)
...
async def fetch_one_video_sub_comment(
    ...
    return await proxy_request("kuaishou", "/api/v1/kuaishou/web/fetch_one_video_sub_comment", params=params)
...
async def generate_share_short_url(
    ...
    if photo_id is not None:
        params["photo_id"] = photo_id
    return await proxy_request("kuaishou", "/api/v1/kuaishou/web/generate_share_short_url", params=params)
...
async def fetch_user_info(
    ...
    return await proxy_request("kuaishou", "/api/v1/kuaishou/web/fetch_user_info", params=params)
...
async def fetch_user_post(
    ...
    if pcursor is not None:
        params["pcursor"] = pcursor
    return await proxy_request("kuaishou", "/api/v1/kuaishou/web/fetch_user_post", params=params)
...
async def fetch_user_live_replay(
    ...
    if pcursor is not None:
        params["pcursor"] = pcursor
    return await proxy_request("kuaishou", "/api/v1/kuaishou/web/fetch_user_live_replay", params=params)
...
async def fetch_user_collect(
    ...
    if pcursor is not None:
        params["pcursor"] = pcursor
    return await proxy_request("kuaishou", "/api/v1/kuaishou/web/fetch_user_collect", params=params)
...
async def fetch_kuaishou_hot_list_v1(
    ...
    return await proxy_request("kuaishou", "/api/v1/kuaishou/web/fetch_kuaishou_hot_list_v1")
...
async def fetch_kuaishou_hot_list_v2(
    ...
    return await proxy_request("kuaishou", "/api/v1/kuaishou/web/fetch_kuaishou_hot_list_v2", params=params)
...
async def fetch_get_user_id(
    ...
    return await proxy_request("kuaishou", "/api/v1/kuaishou/web/fetch_get_user_id", params=params)
