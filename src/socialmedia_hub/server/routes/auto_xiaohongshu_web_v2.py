...
async def fetch_feed_notes(
    ...
    return await proxy_request("xiaohongshu", "/api/v1/xiaohongshu/web_v2/fetch_feed_notes", params=params)
...
async def fetch_feed_notes_v2(
    ...
    if note_id is not None:
        params["note_id"] = note_id
    return await proxy_request("xiaohongshu", "/api/v1/xiaohongshu/web_v2/fetch_feed_notes_v2", params=params)
...
async def fetch_feed_notes_v3(
    ...
    return await proxy_request("xiaohongshu", "/api/v1/xiaohongshu/web_v2/fetch_feed_notes_v3", params=params)
...
async def fetch_feed_notes_v4(
    ...
    if note_id is not None:
        params["note_id"] = note_id
    return await proxy_request("xiaohongshu", "/api/v1/xiaohongshu/web_v2/fetch_feed_notes_v4", params=params)
...
async def fetch_feed_notes_v5(
    ...
    if note_id is not None:
        params["note_id"] = note_id
    return await proxy_request("xiaohongshu", "/api/v1/xiaohongshu/web_v2/fetch_feed_notes_v5", params=params)
...
async def fetch_note_image(
    ...
    if note_id is not None:
        params["note_id"] = note_id
    return await proxy_request("xiaohongshu", "/api/v1/xiaohongshu/web_v2/fetch_note_image", params=params)
...
async def fetch_search_notes(
    ...
    return await proxy_request("xiaohongshu", "/api/v1/xiaohongshu/web_v2/fetch_search_notes", params=params)
...
async def fetch_search_users(
    ...
    if page is not None:
        params["page"] = page
    return await proxy_request("xiaohongshu", "/api/v1/xiaohongshu/web_v2/fetch_search_users", params=params)
...
async def fetch_home_notes(
    ...
    return await proxy_request("xiaohongshu", "/api/v1/xiaohongshu/web_v2/fetch_home_notes", params=params)
...
async def fetch_home_notes_app(
    ...
    if cursor is not None:
        params["cursor"] = cursor
    return await proxy_request("xiaohongshu", "/api/v1/xiaohongshu/web_v2/fetch_home_notes_app", params=params)
...
async def fetch_note_comments(
    ...
    if cursor is not None:
        params["cursor"] = cursor
    return await proxy_request("xiaohongshu", "/api/v1/xiaohongshu/web_v2/fetch_note_comments", params=params)
...
async def fetch_sub_comments(
    ...
    if cursor is not None:
        params["cursor"] = cursor
    return await proxy_request("xiaohongshu", "/api/v1/xiaohongshu/web_v2/fetch_sub_comments", params=params)
...
async def fetch_user_info(
    ...
    if user_id is not None:
        params["user_id"] = user_id
    return await proxy_request("xiaohongshu", "/api/v1/xiaohongshu/web_v2/fetch_user_info", params=params)
...
async def fetch_user_info_app(
    ...
    if user_id is not None:
        params["user_id"] = user_id
    return await proxy_request("xiaohongshu", "/api/v1/xiaohongshu/web_v2/fetch_user_info_app", params=params)
...
async def fetch_follower_list(
    ...
    if cursor is not None:
        params["cursor"] = cursor
    return await proxy_request("xiaohongshu", "/api/v1/xiaohongshu/web_v2/fetch_follower_list", params=params)
...
async def fetch_following_list(
    ...
    if cursor is not None:
        params["cursor"] = cursor
    return await proxy_request("xiaohongshu", "/api/v1/xiaohongshu/web_v2/fetch_following_list", params=params)
...
async def fetch_product_list(
    ...
    if page is not None:
        params["page"] = page
    return await proxy_request("xiaohongshu", "/api/v1/xiaohongshu/web_v2/fetch_product_list", params=params)
...
async def fetch_hot_list(
    ...
    return await proxy_request("xiaohongshu", "/api/v1/xiaohongshu/web_v2/fetch_hot_list")
