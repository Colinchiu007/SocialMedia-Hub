...
async def fetch_one_video(
    ...
    if bv_id is not None:
        params["bv_id"] = bv_id
    return await proxy_request("bilibili", "/api/v1/bilibili/web/fetch_one_video", params=params, json_body=body)
...
async def fetch_one_video_v2(
    ...
    if c_id is not None:
        params["c_id"] = c_id
    return await proxy_request("bilibili", "/api/v1/bilibili/web/fetch_one_video_v2", params=params, json_body=body)
...
async def fetch_one_video_v3(
    ...
    if url is not None:
        params["url"] = url
    return await proxy_request("bilibili", "/api/v1/bilibili/web/fetch_one_video_v3", params=params, json_body=body)
...
async def fetch_video_detail(
    ...
    if aid is not None:
        params["aid"] = aid
    return await proxy_request("bilibili", "/api/v1/bilibili/web/fetch_video_detail", params=params, json_body=body)
...
async def fetch_video_play_info(
    ...
    if url is not None:
        params["url"] = url
    return await proxy_request("bilibili", "/api/v1/bilibili/web/fetch_video_play_info", params=params, json_body=body)
...
async def fetch_video_subtitle(
    ...
    if c_id is not None:
        params["c_id"] = c_id
    return await proxy_request("bilibili", "/api/v1/bilibili/web/fetch_video_subtitle", params=params, json_body=body)
...
async def fetch_hot_search(
    ...
    if limit is not None:
        params["limit"] = limit
    return await proxy_request("bilibili", "/api/v1/bilibili/web/fetch_hot_search", params=params, json_body=body)
...
async def fetch_general_search(
    ...
    return await proxy_request("bilibili", "/api/v1/bilibili/web/fetch_general_search", params=params, json_body=body)
...
async def fetch_video_playurl(
    ...
    if cid is not None:
        params["cid"] = cid
    return await proxy_request("bilibili", "/api/v1/bilibili/web/fetch_video_playurl", params=params, json_body=body)
...
async def fetch_user_post_videos(
    ...
    if order is not None:
        params["order"] = order
    return await proxy_request("bilibili", "/api/v1/bilibili/web/fetch_user_post_videos", params=params, json_body=body)
...
async def fetch_collect_folders(
    ...
    if uid is not None:
        params["uid"] = uid
    return await proxy_request("bilibili", "/api/v1/bilibili/web/fetch_collect_folders", params=params, json_body=body)
...
async def fetch_user_collection_videos(
    ...
    if pn is not None:
        params["pn"] = pn
    return await proxy_request("bilibili", "/api/v1/bilibili/web/fetch_user_collection_videos", params=params, json_body=body)
...
async def fetch_user_profile(
    ...
    if uid is not None:
        params["uid"] = uid
    return await proxy_request("bilibili", "/api/v1/bilibili/web/fetch_user_profile", params=params, json_body=body)
...
async def fetch_user_up_stat(
    ...
    if uid is not None:
        params["uid"] = uid
    return await proxy_request("bilibili", "/api/v1/bilibili/web/fetch_user_up_stat", params=params, json_body=body)
...
async def fetch_user_relation_stat(
    ...
    if uid is not None:
        params["uid"] = uid
    return await proxy_request("bilibili", "/api/v1/bilibili/web/fetch_user_relation_stat", params=params, json_body=body)
...
async def fetch_com_popular(
    ...
    if pn is not None:
        params["pn"] = pn
    return await proxy_request("bilibili", "/api/v1/bilibili/web/fetch_com_popular", params=params, json_body=body)
...
async def fetch_video_comments(
    ...
    if pn is not None:
        params["pn"] = pn
    return await proxy_request("bilibili", "/api/v1/bilibili/web/fetch_video_comments", params=params, json_body=body)
...
async def fetch_comment_reply(
    ...
    if rpid is not None:
        params["rpid"] = rpid
    return await proxy_request("bilibili", "/api/v1/bilibili/web/fetch_comment_reply", params=params, json_body=body)
...
async def fetch_user_dynamic(
    ...
    return await proxy_request("bilibili", "/api/v1/bilibili/web/fetch_user_dynamic", params=params, json_body=body)
...
async def fetch_dynamic_detail(
    ...
    return await proxy_request("bilibili", "/api/v1/bilibili/web/fetch_dynamic_detail", params=params, json_body=body)
...
async def fetch_dynamic_detail_v2(
    ...
    if dynamic_id is not None:
        params["dynamic_id"] = dynamic_id
    return await proxy_request("bilibili", "/api/v1/bilibili/web/fetch_dynamic_detail_v2", params=params, json_body=body)
...
async def fetch_video_danmaku(
    ...
    if cid is not None:
        params["cid"] = cid
    return await proxy_request("bilibili", "/api/v1/bilibili/web/fetch_video_danmaku", params=params, json_body=body)
...
async def fetch_live_room_detail(
    ...
    return await proxy_request("bilibili", "/api/v1/bilibili/web/fetch_live_room_detail", params=params, json_body=body)
...
async def fetch_live_videos(
    ...
    if room_id is not None:
        params["room_id"] = room_id
    return await proxy_request("bilibili", "/api/v1/bilibili/web/fetch_live_videos", params=params, json_body=body)
...
async def fetch_live_streamers(
    ...
    if pn is not None:
        params["pn"] = pn
    return await proxy_request("bilibili", "/api/v1/bilibili/web/fetch_live_streamers", params=params, json_body=body)
...
async def fetch_all_live_areas(
    ...
    body = await request.json()
    return await proxy_request("bilibili", "/api/v1/bilibili/web/fetch_all_live_areas", json_body=body)
...
async def bv_to_aid(
    ...
    if bv_id is not None:
        params["bv_id"] = bv_id
    return await proxy_request("bilibili", "/api/v1/bilibili/web/bv_to_aid", params=params, json_body=body)
...
async def fetch_video_parts(
    ...
    if bv_id is not None:
        params["bv_id"] = bv_id
    return await proxy_request("bilibili", "/api/v1/bilibili/web/fetch_video_parts", params=params, json_body=body)
...
async def fetch_get_user_id(
    ...
    return await proxy_request("bilibili", "/api/v1/bilibili/web/fetch_get_user_id", params=params, json_body=body)
