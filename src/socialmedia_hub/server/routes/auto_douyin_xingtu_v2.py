...
async def get_ranking_list_catalog(
    ...
    return await proxy_request("douyin", "/api/v1/douyin/xingtu_v2/get_ranking_list_catalog", params=params)
...
async def get_ranking_list_data(
    ...
    if limit is not None:
        params["limit"] = limit
    return await proxy_request("douyin", "/api/v1/douyin/xingtu_v2/get_ranking_list_data", params=params)
...
async def get_playlet_actor_rank_list(
    ...
    if limit is not None:
        params["limit"] = limit
    return await proxy_request("douyin", "/api/v1/douyin/xingtu_v2/get_playlet_actor_rank_list", params=params)
...
async def get_author_market_fields(
    ...
    return await proxy_request("douyin", "/api/v1/douyin/xingtu_v2/get_author_market_fields", params=params)
...
async def get_author_base_info(
    ...
    return await proxy_request("douyin", "/api/v1/douyin/xingtu_v2/get_author_base_info", params=params)
...
async def get_author_business_card_info(
    ...
    if o_author_id is not None:
        params["o_author_id"] = o_author_id
    return await proxy_request("douyin", "/api/v1/douyin/xingtu_v2/get_author_business_card_info", params=params)
...
async def get_author_local_info(
    ...
    return await proxy_request("douyin", "/api/v1/douyin/xingtu_v2/get_author_local_info", params=params)
...
async def get_author_show_items(
    ...
    return await proxy_request("douyin", "/api/v1/douyin/xingtu_v2/get_author_show_items", params=params)
...
async def get_author_hot_comment_tokens(
    ...
    return await proxy_request("douyin", "/api/v1/douyin/xingtu_v2/get_author_hot_comment_tokens", params=params)
...
async def get_author_content_hot_keywords(
    ...
    return await proxy_request("douyin", "/api/v1/douyin/xingtu_v2/get_author_content_hot_keywords", params=params)
...
async def get_excellent_case_category_list(
    ...
    if platform_source is not None:
        params["platform_source"] = platform_source
    return await proxy_request("douyin", "/api/v1/douyin/xingtu_v2/get_excellent_case_category_list", params=params)
...
async def get_author_spread_info(
    ...
    if range is not None:
        params["range"] = range
    return await proxy_request("douyin", "/api/v1/douyin/xingtu_v2/get_author_spread_info", params=params)
...
async def get_user_profile_qrcode(
    ...
    return await proxy_request("douyin", "/api/v1/douyin/xingtu_v2/get_user_profile_qrcode", params=params)
...
async def get_content_trend_guide(
    ...
    return await proxy_request("douyin", "/api/v1/douyin/xingtu_v2/get_content_trend_guide")
...
async def get_ip_activity_industry_list(
    ...
    return await proxy_request("douyin", "/api/v1/douyin/xingtu_v2/get_ip_activity_industry_list")
...
async def get_ip_activity_detail(
    ...
    if id is not None:
        params["id"] = id
    return await proxy_request("douyin", "/api/v1/douyin/xingtu_v2/get_ip_activity_detail", params=params)
...
async def get_resource_list(
    ...
    return await proxy_request("douyin", "/api/v1/douyin/xingtu_v2/get_resource_list", params=params)
...
async def get_demander_mcn_list(
    ...
    return await proxy_request("douyin", "/api/v1/douyin/xingtu_v2/get_demander_mcn_list", params=params)
