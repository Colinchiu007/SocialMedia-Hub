...
async def fetch_trend_top(
    ...
    if page is not None:
        params["page"] = page
    return await proxy_request("weibo", "/api/v1/weibo/web/fetch_trend_top", params=params, json_body=body)
...
async def fetch_channel_feed(
    ...
    if page is not None:
        params["page"] = page
    return await proxy_request("weibo", "/api/v1/weibo/web/fetch_channel_feed", params=params, json_body=body)
...
async def fetch_user_info(
    ...
    if uid is not None:
        params["uid"] = uid
    return await proxy_request("weibo", "/api/v1/weibo/web/fetch_user_info", params=params, json_body=body)
...
async def fetch_user_posts(
    ...
    return await proxy_request("weibo", "/api/v1/weibo/web/fetch_user_posts", params=params, json_body=body)
...
async def fetch_post_detail(
    ...
    return await proxy_request("weibo", "/api/v1/weibo/web/fetch_post_detail", params=params, json_body=body)
...
async def fetch_post_comments(
    ...
    return await proxy_request("weibo", "/api/v1/weibo/web/fetch_post_comments", params=params, json_body=body)
...
async def fetch_comment_replies(
    ...
    if max_id is not None:
        params["max_id"] = max_id
    return await proxy_request("weibo", "/api/v1/weibo/web/fetch_comment_replies", params=params, json_body=body)
...
async def fetch_search(
    ...
    return await proxy_request("weibo", "/api/v1/weibo/web/fetch_search", params=params, json_body=body)
