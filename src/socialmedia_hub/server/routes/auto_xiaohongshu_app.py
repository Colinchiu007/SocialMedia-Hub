...
async def get_note_info(
    ...
    return await proxy_request("xiaohongshu", "/api/v1/xiaohongshu/app/get_note_info", params=params)
...
async def get_note_info_v2(
    ...
    if share_text is not None:
        params["share_text"] = share_text
    return await proxy_request("xiaohongshu", "/api/v1/xiaohongshu/app/get_note_info_v2", params=params)
...
async def get_note_comments(
    ...
    return await proxy_request("xiaohongshu", "/api/v1/xiaohongshu/app/get_note_comments", params=params)
...
async def get_sub_comments(
    ...
    if start is not None:
        params["start"] = start
    return await proxy_request("xiaohongshu", "/api/v1/xiaohongshu/app/get_sub_comments", params=params)
...
async def get_notes_by_topic(
    ...
    return await proxy_request("xiaohongshu", "/api/v1/xiaohongshu/app/get_notes_by_topic", params=params)
...
async def search_notes(
    ...
    return await proxy_request("xiaohongshu", "/api/v1/xiaohongshu/app/search_notes", params=params)
...
async def get_user_info(
    ...
    return await proxy_request("xiaohongshu", "/api/v1/xiaohongshu/app/get_user_info", params=params)
...
async def get_user_notes(
    ...
    return await proxy_request("xiaohongshu", "/api/v1/xiaohongshu/app/get_user_notes", params=params)
...
async def extract_share_info(
    ...
    return await proxy_request("xiaohongshu", "/api/v1/xiaohongshu/app/extract_share_info", params=params)
...
async def get_user_id_and_xsec_token(
    ...
    if share_link is not None:
        params["share_link"] = share_link
    return await proxy_request("xiaohongshu", "/api/v1/xiaohongshu/app/get_user_id_and_xsec_token", params=params)
...
async def get_product_detail(
    ...
    return await proxy_request("xiaohongshu", "/api/v1/xiaohongshu/app/get_product_detail", params=params)
...
async def search_products(
    ...
    return await proxy_request("xiaohongshu", "/api/v1/xiaohongshu/app/search_products", params=params)
