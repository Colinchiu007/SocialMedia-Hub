...
async def fetch_search_latest(
    ...
    return await proxy_request("wechat", "/api/v1/wechat_channels/fetch_search_latest", params=params, json_body=body)
...
async def fetch_search_ordinary(
    ...
    if keywords is not None:
        params["keywords"] = keywords
    return await proxy_request("wechat", "/api/v1/wechat_channels/fetch_search_ordinary", params=params, json_body=body)
...
async def fetch_user_search(
    ...
    if page is not None:
        params["page"] = page
    return await proxy_request("wechat", "/api/v1/wechat_channels/fetch_user_search", params=params, json_body=body)
...
async def fetch_user_search_v2(
    ...
    if page is not None:
        params["page"] = page
    return await proxy_request("wechat", "/api/v1/wechat_channels/fetch_user_search_v2", params=params, json_body=body)
...
async def fetch_video_detail(
    ...
    return await proxy_request("wechat", "/api/v1/wechat_channels/fetch_video_detail", params=params, json_body=body)
...
async def fetch_live_history(
    ...
    return await proxy_request("wechat", "/api/v1/wechat_channels/fetch_live_history", params=params, json_body=body)
