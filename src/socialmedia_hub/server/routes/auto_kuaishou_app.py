...
async def fetch_one_video(
    ...
    return await proxy_request("kuaishou", "/api/v1/kuaishou/app/fetch_one_video", params=params)
...
async def fetch_videos_batch(
    ...
    return await proxy_request("kuaishou", "/api/v1/kuaishou/app/fetch_videos_batch", params=params)
...
async def fetch_one_video_by_url(
    ...
    return await proxy_request("kuaishou", "/api/v1/kuaishou/app/fetch_one_video_by_url", params=params)
...
async def fetch_one_video_comment(
    ...
    return await proxy_request("kuaishou", "/api/v1/kuaishou/app/fetch_one_video_comment", params=params)
...
async def fetch_one_user_v2(
    ...
    return await proxy_request("kuaishou", "/api/v1/kuaishou/app/fetch_one_user_v2", params=params)
...
async def fetch_user_live_info(
    ...
    if user_id is not None:
        params["user_id"] = user_id
    return await proxy_request("kuaishou", "/api/v1/kuaishou/app/fetch_user_live_info", params=params)
...
async def fetch_user_hot_post(
    ...
    if pcursor is not None:
        params["pcursor"] = pcursor
    return await proxy_request("kuaishou", "/api/v1/kuaishou/app/fetch_user_hot_post", params=params)
...
async def fetch_user_post_v2(
    ...
    if pcursor is not None:
        params["pcursor"] = pcursor
    return await proxy_request("kuaishou", "/api/v1/kuaishou/app/fetch_user_post_v2", params=params)
...
async def search_comprehensive(
    ...
    return await proxy_request("kuaishou", "/api/v1/kuaishou/app/search_comprehensive", params=params)
...
async def search_video_v2(
    ...
    if page is not None:
        params["page"] = page
    return await proxy_request("kuaishou", "/api/v1/kuaishou/app/search_video_v2", params=params)
...
async def search_user_v2(
    ...
    if page is not None:
        params["page"] = page
    return await proxy_request("kuaishou", "/api/v1/kuaishou/app/search_user_v2", params=params)
...
async def fetch_hot_board_categories(
    ...
    return await proxy_request("kuaishou", "/api/v1/kuaishou/app/fetch_hot_board_categories")
...
async def fetch_hot_board_detail(
    ...
    return await proxy_request("kuaishou", "/api/v1/kuaishou/app/fetch_hot_board_detail", params=params)
...
async def fetch_hot_search_person(
    ...
    return await proxy_request("kuaishou", "/api/v1/kuaishou/app/fetch_hot_search_person")
...
async def fetch_live_top_list(
    ...
    return await proxy_request("kuaishou", "/api/v1/kuaishou/app/fetch_live_top_list", params=params)
...
async def fetch_shopping_top_list(
    ...
    if subTabName is not None:
        params["subTabName"] = subTabName
    return await proxy_request("kuaishou", "/api/v1/kuaishou/app/fetch_shopping_top_list", params=params)
...
async def fetch_brand_top_list(
    ...
    if subTabName is not None:
        params["subTabName"] = subTabName
    return await proxy_request("kuaishou", "/api/v1/kuaishou/app/fetch_brand_top_list", params=params)
...
async def generate_kuaishou_share_link(
    ...
    return await proxy_request("kuaishou", "/api/v1/kuaishou/app/generate_kuaishou_share_link", params=params)
...
async def fetch_magic_face_usage(
    ...
    return await proxy_request("kuaishou", "/api/v1/kuaishou/app/fetch_magic_face_usage", params=params)
...
async def fetch_magic_face_hot(
    ...
    if count is not None:
        params["count"] = count
    return await proxy_request("kuaishou", "/api/v1/kuaishou/app/fetch_magic_face_hot", params=params)
