...
async def shortcode_to_media_id(
    ...
    return await proxy_request("instagram", "/api/v1/instagram/v1/shortcode_to_media_id", params=params)
...
async def media_id_to_shortcode(
    ...
    return await proxy_request("instagram", "/api/v1/instagram/v1/media_id_to_shortcode", params=params)
...
async def user_id_to_username(
    ...
    return await proxy_request("instagram", "/api/v1/instagram/v1/user_id_to_username", params=params)
...
async def fetch_user_info_by_username(
    ...
    return await proxy_request("instagram", "/api/v1/instagram/v1/fetch_user_info_by_username", params=params)
...
async def fetch_user_info_by_username_v2(
    ...
    if username is not None:
        params["username"] = username
    return await proxy_request("instagram", "/api/v1/instagram/v1/fetch_user_info_by_username_v2", params=params)
...
async def fetch_user_info_by_username_v3(
    ...
    if username is not None:
        params["username"] = username
    return await proxy_request("instagram", "/api/v1/instagram/v1/fetch_user_info_by_username_v3", params=params)
...
async def fetch_user_info_by_id(
    ...
    if user_id is not None:
        params["user_id"] = user_id
    return await proxy_request("instagram", "/api/v1/instagram/v1/fetch_user_info_by_id", params=params)
...
async def fetch_user_info_by_id_v2(
    ...
    if user_id is not None:
        params["user_id"] = user_id
    return await proxy_request("instagram", "/api/v1/instagram/v1/fetch_user_info_by_id_v2", params=params)
...
async def fetch_user_about_info(
    ...
    if user_id is not None:
        params["user_id"] = user_id
    return await proxy_request("instagram", "/api/v1/instagram/v1/fetch_user_about_info", params=params)
...
async def fetch_user_posts(
    ...
    return await proxy_request("instagram", "/api/v1/instagram/v1/fetch_user_posts", params=params)
...
async def fetch_user_posts_v2(
    ...
    return await proxy_request("instagram", "/api/v1/instagram/v1/fetch_user_posts_v2", params=params)
...
async def fetch_user_reels(
    ...
    if max_id is not None:
        params["max_id"] = max_id
    return await proxy_request("instagram", "/api/v1/instagram/v1/fetch_user_reels", params=params)
...
async def fetch_user_reposts(
    ...
    if max_id is not None:
        params["max_id"] = max_id
    return await proxy_request("instagram", "/api/v1/instagram/v1/fetch_user_reposts", params=params)
...
async def fetch_user_tagged_posts(
    ...
    if end_cursor is not None:
        params["end_cursor"] = end_cursor
    return await proxy_request("instagram", "/api/v1/instagram/v1/fetch_user_tagged_posts", params=params)
...
async def fetch_related_profiles(
    ...
    if user_id is not None:
        params["user_id"] = user_id
    return await proxy_request("instagram", "/api/v1/instagram/v1/fetch_related_profiles", params=params)
...
async def fetch_search(
    ...
    return await proxy_request("instagram", "/api/v1/instagram/v1/fetch_search", params=params)
...
async def fetch_post_by_url(
    ...
    return await proxy_request("instagram", "/api/v1/instagram/v1/fetch_post_by_url", params=params)
...
async def fetch_post_by_url_v2(
    ...
    if post_url is not None:
        params["post_url"] = post_url
    return await proxy_request("instagram", "/api/v1/instagram/v1/fetch_post_by_url_v2", params=params)
...
async def fetch_post_by_id(
    ...
    return await proxy_request("instagram", "/api/v1/instagram/v1/fetch_post_by_id", params=params)
...
async def fetch_post_comments_v2(
    ...
    return await proxy_request("instagram", "/api/v1/instagram/v1/fetch_post_comments_v2", params=params)
...
async def fetch_comment_replies(
    ...
    if min_id is not None:
        params["min_id"] = min_id
    return await proxy_request("instagram", "/api/v1/instagram/v1/fetch_comment_replies", params=params)
...
async def fetch_music_posts(
    ...
    if max_id is not None:
        params["max_id"] = max_id
    return await proxy_request("instagram", "/api/v1/instagram/v1/fetch_music_posts", params=params)
...
async def fetch_hashtag_posts(
    ...
    if end_cursor is not None:
        params["end_cursor"] = end_cursor
    return await proxy_request("instagram", "/api/v1/instagram/v1/fetch_hashtag_posts", params=params)
...
async def fetch_location_info(
    ...
    return await proxy_request("instagram", "/api/v1/instagram/v1/fetch_location_info", params=params)
...
async def fetch_location_posts(
    ...
    if end_cursor is not None:
        params["end_cursor"] = end_cursor
    return await proxy_request("instagram", "/api/v1/instagram/v1/fetch_location_posts", params=params)
...
async def fetch_cities(
    ...
    if page is not None:
        params["page"] = page
    return await proxy_request("instagram", "/api/v1/instagram/v1/fetch_cities", params=params)
...
async def fetch_locations(
    ...
    if page is not None:
        params["page"] = page
    return await proxy_request("instagram", "/api/v1/instagram/v1/fetch_locations", params=params)
...
async def fetch_explore_sections(
    ...
    return await proxy_request("instagram", "/api/v1/instagram/v1/fetch_explore_sections")
...
async def fetch_section_posts(
    ...
    if max_id is not None:
        params["max_id"] = max_id
    return await proxy_request("instagram", "/api/v1/instagram/v1/fetch_section_posts", params=params)
