...
async def cache_status(
    ...
    return await proxy_request("demo", "/api/v1/demo/demo/cache_status")
...
async def fetch_one_video(
    ...
    return await proxy_request("demo", "/api/v1/demo/douyin/web/fetch_one_video")
...
async def fetch_one_video(
    ...
    return await proxy_request("demo", "/api/v1/demo/douyin/app/fetch_one_video")
...
async def general_search(
    ...
    return await proxy_request("demo", "/api/v1/demo/douyin_search/app/general_search")
...
async def fetch_one_video(
    ...
    return await proxy_request("demo", "/api/v1/demo/kuaishou/web/fetch_one_video")
...
async def fetch_user_profile(
    ...
    return await proxy_request("demo", "/api/v1/demo/tiktok/web/fetch_user_profile")
...
async def fetch_one_video(
    ...
    return await proxy_request("demo", "/api/v1/demo/tiktok/app/fetch_one_video")
...
async def fetch_user_info(
    ...
    return await proxy_request("demo", "/api/v1/demo/instagram/web/fetch_user_info")
...
async def article_extract(
    ...
    return await proxy_request("demo", "/api/v1/demo/wechat/article_extract")
