...
class MCPServer:
    ...
    def __init__(self, api_key: str, base_url: str = "http://127.0.0.1:8000"):
        ...
        from socialmedia_hub.mcp.extended import register_extended_tools, register_extra_tools, register_extra_tools_v2, register_utility_tools_v3
        register_extended_tools(self)
        register_extra_tools(self)
        register_extra_tools_v2(self)
        register_utility_tools_v3(self)
