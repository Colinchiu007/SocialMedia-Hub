...
async def get_article_info(
    ...
    """获取指定文章的信息/Get information of specified article"""
        ...
        return await proxy_request("toutiao", "/api/v1/toutiao/web/get_article_info", json_body=body)
...
async def get_video_info(
    ...
    """获取指定视频的信息/Get information of specified video"""
        ...
        if aweme_id is not None:
            params["aweme_id"] = aweme_id
        body = await request.json()
        return await proxy_request("toutiao", "/api/v1/toutiao/web/get_video_info", json_body=body)
