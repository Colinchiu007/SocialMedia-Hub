...
async def fetch_one_video(
    ...
    """获取单个视频详情信息/Get single video data"""
        ...
        return await proxy_request("bilibili", "/api/v1/bilibili/web/fetch_one_video", json_body=body)
...
async def fetch_one_video_v2(
    ...
    """获取单个视频详情信息V2/Get single video data V2"""
        ...
        if c_id is not None:
            params["c_id"] = c_id
        body = await request.json()
        return await proxy_request("bilibili", "/api/v1/bilibili/web/fetch_one_video_v2", json_body=body)
...
async def fetch_one_video_v3(
    ...
    """获取单个视频详情信息V3/Get single video data V3"""
        ...
        if url is not None:
            params["url"] = url
        body = await request.json()
        return await proxy_request("bilibili", "/api/v1/bilibili/web/fetch_one_video_v3", json_body=body)
...
async def fetch_video_detail(
    ...
    """获取单个视频详情/Get single video detail"""
        ...
        if aid is not None:
            params["aid"] = aid
        body = await request.json()
        return await proxy_request("bilibili", "/api/v1/bilibili/web/fetch_video_detail", json_body=body)
...
async def fetch_video_play_info(
    ...
    """获取单个视频播放信息/Get single video play info"""
        ...
        if url is not None:
            params["url"] = url
        body = await request.json()
        return await proxy_request("bilibili", "/api/v1/bilibili/web/fetch_video_play_info", json_body=body)
...
async def fetch_video_subtitle(
    ...
    """获取视频字幕信息/Get video subtitle info"""
        ...
        if c_id is not None:
            params["c_id"] = c_id
        body = await request.json()
        return await proxy_request("bilibili", "/api/v1/bilibili/web/fetch_video_subtitle", json_body=body)
...
async def fetch_hot_search(
    ...
    """获取热门搜索信息/Get hot search data"""
        ...
        if limit is not None:
            params["limit"] = limit
        body = await request.json()
        return await proxy_request("bilibili", "/api/v1/bilibili/web/fetch_hot_search", json_body=body)
...
async def fetch_general_search(
    ...
    """获取综合搜索信息/Get general search data"""
        ...
        body = await request.json()
        return await proxy_request("bilibili", "/api/v1/bilibili/web/fetch_general_search", json_body=body)
...
async def fetch_video_playurl(
    ...
    """获取视频流地址/Get video playurl"""
        ...
        if cid is not None:
            params["cid"] = cid
        body = await request.json()
        return await proxy_request("bilibili", "/api/v1/bilibili/web/fetch_video_playurl", json_body=body)
...
async def fetch_user_post_videos(
    ...
    """获取用户主页作品数据/Get user homepage video data"""
        ...
        if order is not None:
            params["order"] = order
        body = await request.json()
        return await proxy_request("bilibili", "/api/v1/bilibili/web/fetch_user_post_videos", json_body=body)
...
async def fetch_collect_folders(
    ...
    """获取用户所有收藏夹信息/Get user collection folders"""
        ...
        if uid is not None:
            params["uid"] = uid
        body = await request.json()
        return await proxy_request("bilibili", "/api/v1/bilibili/web/fetch_collect_folders", json_body=body)
...
async def fetch_user_collection_videos(
    ...
    """获取指定收藏夹内视频数据/Gets video data from a collection folder"""
        ...
        if pn is not None:
            params["pn"] = pn
        body = await request.json()
        return await proxy_request("bilibili", "/api/v1/bilibili/web/fetch_user_collection_videos", json_body=body)
...
async def fetch_user_profile(
    ...
    """获取指定用户的信息/Get information of specified user"""
        ...
        if uid is not None:
            params["uid"] = uid
        body = await request.json()
        return await proxy_request("bilibili", "/api/v1/bilibili/web/fetch_user_profile", json_body=body)
...
async def fetch_user_up_stat(
    ...
    """获取UP主状态统计/Get UP stat (total likes and views)"""
        ...
        if uid is not None:
            params["uid"] = uid
        body = await request.json()
        return await proxy_request("bilibili", "/api/v1/bilibili/web/fetch_user_up_stat", json_body=body)
...
async def fetch_user_relation_stat(
    ...
    """获取用户关系状态统计/Get user relation stat (following and followers)"""
        ...
        if uid is not None:
            params["uid"] = uid
        body = await request.json()
        return await proxy_request("bilibili", "/api/v1/bilibili/web/fetch_user_relation_stat", json_body=body)
...
async def fetch_com_popular(
    ...
    """获取综合热门视频信息/Get comprehensive popular video information"""
        ...
        if pn is not None:
            params["pn"] = pn
        body = await request.json()
        return await proxy_request("bilibili", "/api/v1/bilibili/web/fetch_com_popular", json_body=body)
...
async def fetch_video_comments(
    ...
    """获取指定视频的评论/Get comments on the specified video"""
        ...
        if pn is not None:
            params["pn"] = pn
        body = await request.json()
        return await proxy_request("bilibili", "/api/v1/bilibili/web/fetch_video_comments", json_body=body)
...
async def fetch_comment_reply(
    ...
    """获取视频下指定评论的回复/Get reply to the specified comment"""
        ...
        if rpid is not None:
            params["rpid"] = rpid
        body = await request.json()
        return await proxy_request("bilibili", "/api/v1/bilibili/web/fetch_comment_reply", json_body=body)
...
async def fetch_user_dynamic(
    ...
    """获取指定用户动态/Get dynamic information of specified user"""
        ...
        body = await request.json()
        return await proxy_request("bilibili", "/api/v1/bilibili/web/fetch_user_dynamic", json_body=body)
...
async def fetch_dynamic_detail(
    ...
    """获取动态详情/Get dynamic detail"""
        ...
        body = await request.json()
        return await proxy_request("bilibili", "/api/v1/bilibili/web/fetch_dynamic_detail", json_body=body)
...
async def fetch_dynamic_detail_v2(
    ...
    """获取动态详情v2/Get dynamic detail v2"""
        ...
        if dynamic_id is not None:
            params["dynamic_id"] = dynamic_id
        body = await request.json()
        return await proxy_request("bilibili", "/api/v1/bilibili/web/fetch_dynamic_detail_v2", json_body=body)
...
async def fetch_video_danmaku(
    ...
    """获取视频实时弹幕/Get Video Danmaku"""
        ...
        if cid is not None:
            params["cid"] = cid
        body = await request.json()
        return await proxy_request("bilibili", "/api/v1/bilibili/web/fetch_video_danmaku", json_body=body)
...
async def fetch_live_room_detail(
    ...
    """获取指定直播间信息/Get information of specified live room"""
        ...
        body = await request.json()
        return await proxy_request("bilibili", "/api/v1/bilibili/web/fetch_live_room_detail", json_body=body)
...
async def fetch_live_videos(
    ...
    """获取直播间视频流/Get live video data of specified room"""
        ...
        if room_id is not None:
            params["room_id"] = room_id
        body = await request.json()
        return await proxy_request("bilibili", "/api/v1/bilibili/web/fetch_live_videos", json_body=body)
...
async def fetch_live_streamers(
    ...
    """获取指定分区正在直播的主播/Get live streamers of specified live area"""
        ...
        if pn is not None:
            params["pn"] = pn
        body = await request.json()
        return await proxy_request("bilibili", "/api/v1/bilibili/web/fetch_live_streamers", json_body=body)
...
async def bv_to_aid(
    ...
    """通过bv号获得视频aid号/Generate aid by bvid"""
        ...
        if bv_id is not None:
            params["bv_id"] = bv_id
        body = await request.json()
        return await proxy_request("bilibili", "/api/v1/bilibili/web/bv_to_aid", json_body=body)
...
async def fetch_video_parts(
    ...
    """通过bv号获得视频分p信息/Get Video Parts By bvid"""
        ...
        if bv_id is not None:
            params["bv_id"] = bv_id
        body = await request.json()
        return await proxy_request("bilibili", "/api/v1/bilibili/web/fetch_video_parts", json_body=body)
...
async def fetch_get_user_id(
    ...
    """提取用户ID/Extract user ID"""
        ...
        body = await request.json()
        return await proxy_request("bilibili", "/api/v1/bilibili/web/fetch_get_user_id", json_body=body)
