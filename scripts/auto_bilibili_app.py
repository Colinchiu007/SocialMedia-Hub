...
async def fetch_one_video(
    ...
    """获取单个视频详情信息/Get single video data"""
        ...
        return await proxy_request("bilibili", "/api/v1/bilibili/app/fetch_one_video", json_body=body)
...
async def fetch_video_comments(
    ...
    """获取视频评论列表/Get video comments"""
        ...
        body = await request.json()
        return await proxy_request("bilibili", "/api/v1/bilibili/app/fetch_video_comments", json_body=body)
...
async def fetch_reply_detail(
    ...
    """获取二级评论回复/Get reply detail"""
        ...
        if ps is not None:
            params["ps"] = ps
        body = await request.json()
        return await proxy_request("bilibili", "/api/v1/bilibili/app/fetch_reply_detail", json_body=body)
...
async def fetch_user_videos(
    ...
    """获取用户投稿视频/Get user videos"""
        ...
        if ps is not None:
            params["ps"] = ps
        body = await request.json()
        return await proxy_request("bilibili", "/api/v1/bilibili/app/fetch_user_videos", json_body=body)
...
async def fetch_user_info(
    ...
    """获取用户信息/Get user info"""
        ...
        if user_id is not None:
            params["user_id"] = user_id
        body = await request.json()
        return await proxy_request("bilibili", "/api/v1/bilibili/app/fetch_user_info", json_body=body)
...
async def fetch_home_feed(
    ...
    """获取主页推荐视频流/Get home feed"""
        ...
        if pull is not None:
            params["pull"] = pull
        body = await request.json()
        return await proxy_request("bilibili", "/api/v1/bilibili/app/fetch_home_feed", json_body=body)
...
async def fetch_popular_feed(
    ...
    """获取热门推荐/Get popular feed"""
        ...
        body = await request.json()
        return await proxy_request("bilibili", "/api/v1/bilibili/app/fetch_popular_feed", json_body=body)
...
async def fetch_search_all(
    ...
    """综合搜索/search all"""
        ...
        if order is not None:
            params["order"] = order
        body = await request.json()
        return await proxy_request("bilibili", "/api/v1/bilibili/app/fetch_search_all", json_body=body)
...
async def fetch_search_by_type(
    ...
    """分类搜索/ search by type"""
        ...
        if order is not None:
            params["order"] = order
        body = await request.json()
        return await proxy_request("bilibili", "/api/v1/bilibili/app/fetch_search_by_type", json_body=body)
